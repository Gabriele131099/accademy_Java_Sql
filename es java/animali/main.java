    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (flagOpenProgram) {
                ...
                System.out.println( roditori.specie.toUpperCase());
                roditori.showAllAnimal();
                System.out.println( anfibi.specie.toUpperCase());
                anfibi.showAllAnimal();
                System.out.println( canidi.specie.toUpperCase());
                canidi.showAllAnimal();
                System.out.println( felini.specie.toUpperCase());
